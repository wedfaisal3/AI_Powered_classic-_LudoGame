...
Python and Tainter to provide a graphical interface, while the AI relies on a heuristic-based
decision-making approach. The goal of the project is to demonstrate the application of artificial
intelligence techniques within a small, functional game environment
